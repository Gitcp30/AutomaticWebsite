        ...
        <div class="col-xs-12">
            ...
            <div id="toolbar" class="toolbar-cc clearfix p12">
                <div class="form-inline" role="form" data-spy="affix" data-offset-top="159">
                    <div class="pull-left">
                        <button class="btn btn-primary" id="bullentinBoard-add-button" type="button" >
                            <i class="fa fa-plus mr5" aria-hidden="true"></i>新增
                        </button>
                        <button class="btn btn-primary" id="bullentinBoard-delete-button" type="button" >
                            <i class="fa fa-trash-o mr5" aria-hidden="true"></i>删除
                        </button>
                        <button class="btn btn-primary" id="bullentinBoard-enable-button" type="button" >
                            <i class="fa fa-unlock mr5" aria-hidden="true"></i>启用
                        </button>
                        <button class="btn btn-primary" id="bullentinBoard-disable-button" type="button" >
                            <i class="fa fa-lock mr5" aria-hidden="true"></i>停用
                        </button>
                        <button class="btn btn-primary" id="bullentinBoard-stick-button" type="button" >
                            <i class="fa fa-lock mr5" aria-hidden="true"></i>置顶
                        </button>
                        <button class="btn btn-primary" id="bullentinBoard-seniorQuery-button" type="button" >
            ...
            <div class="table-responsive">
                <table class=" table-striped" id="bullentinBoardTable" >
                </table>
            </div>
        </div>
    </div>
...
<script src="${ctx}/assets/js/admin/web/bullentinBoardList.js"></script>