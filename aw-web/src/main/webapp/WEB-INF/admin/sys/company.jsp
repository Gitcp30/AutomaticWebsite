            ...
            <div id="toolbar" class="toolbar-cc clearfix p12">
                <div class="form-inline" role="form" data-spy="affix" data-offset-top="159">
                    <div class="pull-left">
                        ...
                        <button class="btn btn-primary" id="company-query-button" type="button" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="max-height: 800px;">
                <div class="row">
                    <div class="col-xs-12">
                        <!-- main content -->
                        <div id="toolbar2" class="toolbar-cc clearfix p12">
                            <div class="form-inline" role="form" data-spy="affix" data-offset-top="159">
                                <div class="pull-left">
                                    <button class="btn btn-primary" id="company-delete-button1" type="button" >
                                        <i class="fa fa-trash-o mr5" aria-hidden="true"></i>删除
                                    </button>
                                    <button class="btn btn-primary" id="company-enable-button1" type="button" >
                                        <i class="fa fa-unlock mr5" aria-hidden="true"></i>启用
                                    </button>
                                    <button class="btn btn-primary" id="company-disable-button1" type="button" >
                                        <i class="fa fa-lock mr5" aria-hidden="true"></i>停用
                                    </button>
                                </div>
                            </div>
