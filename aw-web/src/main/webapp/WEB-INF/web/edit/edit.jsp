										...
										<div class="widget-main">
											<div class="row">
												<div class="col-xs-4 col-sm-4">
													<label>
														<input name="background_background_radio" type="radio" class="ace" value="default" />
														<span class="lbl">默认</span>
													</label>
												</div>
												<div class="col-xs-4 col-sm-4">
													<label>
														<input name="background_background_radio" type="radio" class="ace" value="hide"/>
														<span class="lbl">隐藏</span>
													</label>
												</div>
												<div class="col-xs-4 col-sm-4">
													<label>
														<input name="background_background_radio" type="radio" class="ace" value="custom" checked="true" />
											...
											<div class="row content">
												<div class="col-xs-4 col-md-4">
													<label for="simple-colorpicker-1">颜色 </label>
												</div>
										...
										<div class="widget-main">
											<div class="row">
												<div class="col-xs-6 col-sm-4">
													<label>
														<input name="background_width_radio" type="radio" class="ace" value="default"  checked="true"/>
														<span class="lbl">默认</span>
													</label>
												</div>
												<div class="col-xs-6 col-sm-4">
													<label>
														<input name="background_width_radio" type="radio" class="ace" value="custom" />
														<span class="lbl">自定义</span>
													</label>
												</div>
											</div>
											<div class="row content">
												<div class="col-xs-6 col-md-6">
													<span class="ui-slider-blue ui-slider-small">1000</span>
												</div>
			...
			<div class="modal-dialog" style="width: 850px;">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button id="bannerModal_footer_commitbtn" type="button" class="btn btn-primary ">提交更改</button>
					</div>
				</div>
				<!-- /.modal-content -->
			</div>
